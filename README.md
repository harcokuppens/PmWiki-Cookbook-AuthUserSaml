...
This extension uses the SAML implementation library from SimpleSAMLphp (https://simplesamlphp.org) for integrating SAML authentication into PmWiki's identity-based authorization system named [AuthUser](https://www.pmwiki.org/wiki/Cookbook/AuthUser). Look at the documentation about SimpleSAMLphp at https://simplesamlphp.org/docs and in particularly the SimpleSAMLphp Service Provider QuickStart page.
